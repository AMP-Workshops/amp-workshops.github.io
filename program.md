...
{% if tentative %}
Please be aware that this is a tentative version of the workshop program.
The finalised version will be published at the beginning of November.
{% endif %}
  ...
  <tbody>
      ...
      <tr {% if event.non-session %} style="background-color:#ececec"{% endif %}>
        ...
        <td class="right-td">
          ...
          {% if event.slides %}
            <br>
            <a target="_blank" style="color:white" href="{{site.url}}/assets/presentations/{{event.slides}}"><label class="btn btn-xs btn-success">
